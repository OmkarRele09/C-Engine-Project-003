# 📏 C-Engine-003 — GeoMetric Area Calculator  

🚀 Part of my **C-Engine Series** — beginner-friendly, real-world C projects to master the logic behind engineering and computation.
